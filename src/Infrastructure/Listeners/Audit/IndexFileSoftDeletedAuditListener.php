...
class IndexFileSoftDeletedAuditListener implements ShouldQueue
{
    ...
    public function handle(FileSoftDeleted $event): void
    {
        try {
            $this->auditIndexService->index(UserActivityAuditDTO::from([
                'event_id' => (string) str()->uuid(),
                'action' => UserActivityAction::SOFT_DELETED,
            ...
            logger()->error('[IndexFileSoftDeletedAuditListener.handle] failed to index audit document', [
